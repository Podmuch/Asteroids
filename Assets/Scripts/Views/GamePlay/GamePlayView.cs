...
namespace Asteroids.GamePlay
{
    ...
    public class GamePlayView : AbstractView
    {
        ...
        public GamePlayView(Transform _backgroundImage)
        {
            ...
            finalWindowMargin = new Vector2((Screen.width - finalWindowSize.x) * 0.5f, 0);
            margin = Vector2.zero;
            style = new GUIStyle();
        ...
        public override bool Draw(System.Object drawParams)
        {
            ...
            else
            {
                ...
                nick = GUI.TextField(new Rect(finalWindowMargin.x, finalWindowMargin.y + finalWindowSize.y * 0.25f, finalWindowSize.x, finalWindowSize.y * 0.25f), nick, boxStyle);
                boxStyle.alignment = TextAnchor.UpperCenter;
                GUI.Box(new Rect(finalWindowMargin.x, finalWindowMargin.y+finalWindowSize.y * 0.5f, finalWindowSize.x, finalWindowSize.y * 0.25f), "YOUR SCORE: " + lastScore, style);
